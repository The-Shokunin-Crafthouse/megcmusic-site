...
- **Current sprint:** `stages/03-build/sprint-14-launch-readiness/` (filed 2026-09-14 — the deploy alarm, the shop's launch gate, and the four Gate-3 checks that were never run). Last closed: `stages/03-build/sprint-13-home-blocks/` (Home content blocks — one flexible zone after Instagram, three block types; complete 2026-09-11; save-to-live measured at ~2 min / ~120 s). Hotfix filed beside it 2026-09-17: `stages/03-build/sprint-15-save-path-resilience/` (retry every build-time WP read; the pointer stays on Sprint 14). Also filed beside it 2026-09-17: `stages/03-build/sprint-16-front-door-and-dead-fields/` (WordPress links and redirects to the live site; the six field groups that fed nothing; the pointer stays on Sprint 14). And `stages/03-build/sprint-17-page-layouts/` (Page layout on every page — reorder, hide, five block types; pointer stays on Sprint 14). And `stages/03-build/sprint-18-absorb-old-theme/` (the last three old-theme pages absorbed; footer on every page; pointer stays on Sprint 14)
